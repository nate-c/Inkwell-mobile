...
class ResetPasswordState extends State<ResetPassword> {
  ...
  final TextEditingController _confirmnewpwController =
    ...
    return Scaffold(
        ...
        body: Center(
          ...
          children: <Widget>[
            Text(
              'Reset Password',
              style: TextStyle(fontSize: 20, color: ColorConstants.bodyText),
            ),
            Container(
                ...
                child: TextFormField(
                  ...
                  style:
                      TextStyle(color: ColorConstants.bodyText, fontSize: 15),
                )),
            Container(
                color: ColorConstants.textFieldBox,
                margin: new EdgeInsets.all(15),
            ...
            ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (_confirmnewpwController.text == newPassword &&
                      newPassword != _oldpwController.text) {
                    //Code for URI
                    var response = await http.post(
                        Uri.parse(UriConstants.resetPasswordUri),
                        headers: {
